...
>(({ className, variant = "horizontal", ...props }, ref) => {
  const baseStyles =
    variant === "vertical"
      ...
      : "inline-flex h-10 items-center justify-center bg-muted  p-1 text-muted-foreground w-fit";
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "w-full px-4 py-2 text-sm text-left rounded-md cursor-pointer transition-colors font-medium",
